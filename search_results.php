...
<div class="container">
  ...
  <div class="jumbotron">
    <h1><?php echo $found; ?> Notes Found</h1>
    <?php if($found == "No"){ ?>
    <p>Try Searching with a different keyword.</p>
    <?php }else{ ?>      
    <p>Here are some notes that are found on your searched keyword.</p>
    <?php } ?>      
  </div> <!-- div close for jumbotron -->
<?php if($found != 0){ ?>
 <div id="products" class="row list-group">
       <?php 
                $query = "SELECT * FROM uploads WHERE file_id in ($ids)";
...
} //for if condition of no results found.
                 ?>
